...
export default function LoginPage() {
  ...
  useEffect(() => {
    ...
    const checkExistingSession = async () => {
      try {
        ...
        if (res.ok && data?.success && data.admin && !cancelled) {
  ...
  if (checking) {
    return <div className="min-h-screen flex items-center justify-center bg-gray-50 text-gray-500">Checking session...</div>;
  }
