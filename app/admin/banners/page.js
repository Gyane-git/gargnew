...
export default function BannerList() {
  ...
  const getImage = (banner) => {
    const image =
      ...
      banner.image_url ||
      banner.file_path_full_url ||
      banner.file_path ||
      banner.mobile_file_path_full_url ||
      banner.mobile_file_path;
    ...
    if (banner.mobile_file_path)
      return `/uploads/carousel/${banner.mobile_file_path}`;
    return "/no-image.png";
  };
