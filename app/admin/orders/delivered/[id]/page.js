  ...
  if (!order) {
    return (
      <div className="min-h-screen bg-slate-50 flex flex-col items-center justify-center gap-4">
        ...
        <Link href="/admin/orders/delivere" className="text-blue-600 hover:underline">
          Back to Orders
        </Link>
      </div>
    );
        ...
        <div className="bg-white rounded-md shadow-xl">
          ...
          <div className="flex flex-wrap items-center justify-between gap-4 px-6 py-5 border-b border-slate-100">
            ...
            <div className="flex items-center gap-3">
              ...
              <Link href="/admin/orders/delivered" className="flex items-center gap-2 border border-blue-500 text-blue-600 hover:bg-blue-50 text-sm font-medium px-4 py-2 rounded">
                <ArrowLeft size={16} />
                Back to Orders
              </Link>
            </div>
