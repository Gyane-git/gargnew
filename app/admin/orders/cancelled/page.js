                  ...
                  return (
                    <tr key={row.orderId} className="border-b border-slate-100 hover:bg-slate-50">
                      ...
                      <td className="py-4 pr-4">
                        <Link href={`/admin/orders/cancelled/${cleanId}`} className="text-blue-600 hover:underline">
                          {row.orderId}
                        </Link>
                      </td>
                      ...
                      <td className="py-4 pr-4">
                        ...
                        <Link href={`/admin/orders/cancelled/${cleanId}`} className="w-6 h-6 flex items-center justify-center rounded-full bg-sky-500 hover:bg-sky-600 text-white">
                          <Info size={14} />
                        </Link>
                      </td>
                    </tr>
