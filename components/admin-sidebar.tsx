...
const menuItems = [
  ...
  },
  {
    ...
    expandable: true,
    children: [
      { name: "About Company", path: "/admin/settings/general", icon: Settings },
      { name: "About Us", path: "/admin/settings/countries", icon: MapPin },
      { name: "Our Team", path: "/admin/settings/intakes", icon: Calendar },
      { name: "Terms & Conditions", path: "/admin/settings/email", icon: Mail },
      { name: "Business Registration", path: "/admin/settings/api", icon: Settings },
      { name: "Medical Certifications", path: "/admin/settings/analytics", icon: BarChart3 },
      { name: "Return & Refunds Policy", path: "/admin/settings/seo", icon: Settings },
      { name: "Privacy Policy", path: "/admin/settings/seo", icon: HelpCircle },
    ],
  },
];
